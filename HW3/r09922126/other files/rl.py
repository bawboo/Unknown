...
class DataTrainingArguments:
    ...
    output_file: Optional[str] = field(
        ...
        metadata={
            "help": "An optional output data file with jsonl format."
        },
    )
...
def main():
    ...
    if training_args.do_predict:
        ...
        predict_dataloader = DataLoader(tokenizer(raw_datasets["test"]["maintext"],
        ...
        predictions = []
        for test_input in tqdm(predict_dataloader, total=len(predict_dataloader)):
            prediction = model.generate(input_ids=test_input.cuda(), 
                                        num_beams=num_beams,
            ...
            if training_args.predict_with_generate:
                ...
                with open(output_prediction_file, "w") as f:
                    for id, pred in zip(ids, predictions):
                        f.write(json.dumps({"id":id, "title":pred})+ "\n")
