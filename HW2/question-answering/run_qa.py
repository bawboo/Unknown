...
class DataTrainingArguments:
    ...
    output_file: Optional[str] = field(
        default="result",
        metadata={"help": "An optional output file path(a text file)."},
    )
    ...
    log_path: Optional[str] = field(
        default="./traing_log.pkl", metadata={"help": "logs of training process."}
    )
...
def main():
    ...
    if training_args.do_predict:
        ...
        try:
            with open(data_args.output_file, "wb") as f:
                pickle.dump(results, f)
        except:
            print("pickle dump result failed")
